...
.NOTES
    ...
    1.9 - Regex v2.4: Added pinterest, reddit, snapchat, tiktok
...
# Main ad-blocking regex pattern (v2.4)
# Changes in v2.4:
#   - Added: pinterest, reddit, snapchat, tiktok (major social media advertising platforms)
# Changes in v2.3:
